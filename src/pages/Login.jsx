                        ...
                        <div className='md:w-2/3 w-11/12'>
                            ...
                            <div>
                                <form>
                                    ...
                                    <div className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 w-20 font-medium rounded-lg text-sm px-5 py-2.5 text-center'>Login</div>

                                    <p className='mt-3 text-sm font-medium text-gray-900'>Dont have an account? <Link className='text-blue-500' to={"/kodecamp-ecommerce/"}>register</Link> instead </p>
                                </form>
                            </div>
                        </div>
                    </div>
